...
from data_load import MultiLabelDataset
...
def main():
    ...
    try:
        ...
        # train_dataset = MultiLabelDataset(annRoot="./annotations", imgRoot="/mnt/H/qh_data/Sewer", split="Train", transform=transform)
        train_dataset = MultiLabelDataset(annRoot="./annotations", imgRoot="/mnt/H/qh_data/Sewer/devdisk/Sewer", split="Train", transform=transform)
        train_loader = script_utils.cycle(DataLoader(train_dataset, batch_size=batch_size, shuffle=True, drop_last=True, num_workers=2))
        # test_dataset = MultiLabelDataset(annRoot="./annotations", imgRoot="/mnt/H/qh_data/Sewer", split="Valid", transform=transform)
        test_dataset = MultiLabelDataset(annRoot="./annotations", imgRoot="/mnt/H/qh_data/Sewer/devdisk/Sewer", split="Valid", transform=transform)
